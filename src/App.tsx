		...
		<>
			<div className="row screen">
					...
					<div className="row">
						...
						<div className="col-md-12">
							<p>
								...
								Sivayogeith Umamaheswaran AKA thecodingsage.
							</p>
				...
				<div className="col-md-12 screen">
					<div className="row">
						<div className="col-md-12">
							<h1>Happy Birthday, Akkama!</h1>
						</div>
						<div className="col-md-12">
							<p>
								Sorry, but I can't give you an real-life present
								(cause im broke lol), but I have an present for
								you online.
							</p>
							<p>Which you will see at the last screen!</p>
						</div>
					</div>
				</div>
				<div className="col-md-12">
					<div className="row">
						...
						<div className="col-md-12">
							<p>Sorry about the glitches, Im such an bad dev!</p>
						</div>
					</div>
				</div>
				<div className="col-md-12 screen">
				...
				<div className="col-md-12 screen">
					<div className="row">
						...
						<div className="col-md-12">
							<p>
								Sis, i love you! now you need to open my
								present, lol i might have copied my old present!
								XD
							</p>
						</div>
					</div>
					...
					<Button
						...
						onClick={() => {
							Swal.fire({
								...
								html: "<p> I GOT YOU! MUHAHHAHAHHAHAH!</p> <p>NEVER GONNA GIVE YOU UP! XDXD oh my god! </p> <p>i cant stop laughing oh god!</p> <p>Oh my god sis! Anyway that was an joke so Happy Birthday!</p>",
								icon: "success",
							});
							scrollToBottom();
						}}
